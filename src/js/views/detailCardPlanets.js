...
export const DetailCardPlanets = props => {
		...
		<div className="card-deck col-3 h-100 mb-2 ">
			<div className="card" style={{ width: "18rem" }}>
				...
				<div className="card-body">
					...
					<p className="card-text">Terrain: {store.planets[props.match.params.theid].terrain}</p>
					<p>Climate: {store.planets[props.match.params.theid].climate}</p>
					<p>Surface Water: {store.planets[props.match.params.theid].surface_water}</p>
					<p>Population: {store.planets[props.match.params.theid].population}</p>
				</div>{" "}
				<Link to="/">
