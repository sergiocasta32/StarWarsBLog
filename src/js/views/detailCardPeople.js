			...
			<div className="card-deck col-3 h-100 mb-3 text-center">
				<div className="card" style={{ width: "18rem" }}>
					...
					<div className="card-body">
						...
						<p className="card-text">Gender: {store.people[props.match.params.theid].gender}</p>
						<p>Height: {store.people[props.match.params.theid].height}</p>
						<p>Mass: {store.people[props.match.params.theid].mass}</p>
						<p>Hair color: {store.people[props.match.params.theid].hair_color}</p>
						<p>Skin color: {store.people[props.match.params.theid].skin_color}</p>
						<p>Eye color: {store.people[props.match.params.theid].eye_color}</p>
						<p>Birth year: {store.people[props.match.params.theid].birth_year}</p>
					</div>{" "}
					<Link to="/">
						<span className="btn btn-primary btn-lg mb-2" href="#" role="button">
							Back home
						</span>
					</Link>
				</div>
